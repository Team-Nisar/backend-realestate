...
// const ID = App.Config.AWS.ACCESS_KEY
// const SECRET = App.Config.AWS.SECRET_KEY
// const REGION = App.Config.AWS.REGION
// const SES_DEFAULT_EMAIL = App.Config.AWS.SES_SENDER_EMAIL
...
// 		const { returnTemplate } = await import(`../templates/${templateName}.ts`)
